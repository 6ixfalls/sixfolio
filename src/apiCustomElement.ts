...
// Migrated by 6ixfalls to Vue v3.3.4
...
export class VueElement extends BaseClass {
    ...
    constructor(
        ...
        super();
        this._config = extend({ shadowRoot: true }, this._config);
    ...
    private _createVNode(): VNode<any, any> {
        ...
        if (!this._config.shadowRoot) {
            childs = () => {
                ...
                return this._slots.map((n: HTMLElement) => {
                    const attrs = n.attributes ? toObj(n.attributes) : {};
                    //@ts-ignore - innerHTML is not in the type definition
        ...
        if (!this._instance) {
            ...
            vnode.ce = (instance) => {
                ...
                while (
                    (parent =
                        parent &&
                        (parent.parentNode || (parent as ShadowRoot).host))
                ) {
